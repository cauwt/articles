...
Cumulative indicators are statistics of some states of entities (drivers, passengers), e.g., Total Count of Registered Drivers and Total Count of Registered Passengers. We also need to maintain the atomic indicators and decorators, based on which they are created. generally the corresponding time period refers to "a certain current time since origin".
...
The development flow is a technical guidance for engineers to develop, maintain and quality-control indicator matrix. The flow can also be a communication bridge between data warehouse developers and data product managers/data analysts.
![](img/im_11_en.png)
